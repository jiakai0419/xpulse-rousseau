...
- `scripts/display-original-capture-core.mjs`: hold pure capture rules such as target normalization, screenshot-probe validation, clip scaling, and retry classification so Chrome orchestration stays thin and testable;
