...
- `scripts/display-original-evidence-cache-core.mjs`: hold pure Original evidence cache rules such as capture-batch compaction, invalid-before-missing batch planning, and stable report rendering;
